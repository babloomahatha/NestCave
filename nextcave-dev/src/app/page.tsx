        ...
        sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52'>
          ...
          flex flex-col items-center lg:items-start">
            <div className="absolute w-28 left-0-top-20 hidden lg:block">
              <img src="/snake-1.png" className="h-950 w-950"/>
            </div>
            ...
            <p className="mt-8 text-lg:pr-10 max-w-prose text-center
            lg:text-left text-balance md:text-wrap">Capture Your Favourite memories with Your Own,<span className="font-semibold">one-of-one</span>Phone Case.
            NextCave allows you to protect your memories,not just your phone.</p>
            <ul className="mt-8 space-y-2 text-left font-medium flex flex-col items-center sm:items-start">
              ...
              <li className="flex gap-1.5 items-center text-left">
                ...
                <li className="flex gap-1.5 items-center text-left">
                 <Check className="h-5 w-5 shrink-0 text-green-600"/>
                  Modern Smartphone(Iphone,Samsung,Pixel) Supported
                </li>
              </div>
            </ul>
          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16
      ...
      <section className="bg-slate-100 py-24">
        ...
        sm:gap-32">
          ...
          sm:gap-6">
           ...
           md:text-6xl text-gray-900 ">What our{' '} <span className="relative px-2"> customer{' '}<Icons.underline className='hidden sm:block
           pointer-events-none absolute inset-x-0 -bottom-6 text-green-500' /> says
           </span>{' '}
           </h2>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>"The Case feels Durable and i even got a compliment on the design.
                  ...
                  the image started fading yellowish color after a couple of weeks.Love it."
                  </p>
              </div>
              <div className="flex gap-4 mt-2">
                <img className="rounded-full h-12 w-12 object-cover" src="/users/user-1.png" alt="user"/>
                <div className="flex flex-col">
                  <p className="font-semibold">Nirtendra</p>
      ...
      <section>
        <MaxWidthWrapper className="py-24">
          <div className="mb-12 px-6 lg:px-8">
            <div className="mx-aut max-w-2xl sm:text-center">

            <h2 className=" order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl
           md:text-6xl text-gray-900 ">Upload Your Photo and get{' '} <span className="relative px-2 bg-green-600 text-white"> your own case now
           </span>{' '}
           </h2>
            </div>
          </div>
