...
const STEPS = [
    ...
    {
        name:"Step 2: Add Customize design",
                ...
                <div>
                  ...
                  <span className={cn( i !== 0 ? 'lg:pl-9':'','flex items-center px-6 py-4 text-sm font-medium'
                    ...
                    <span className={cn('text-sm font-semibold text-zinc-700', {
                          'text-primary': isCompleted,'text-zinc-700': isCurrent,
                        })}>
                        {step.name}
                    </span>
                  ...
                  {i !== 0 ? (<div className='absolute inset-0 hidden w-3 lg:block'><svg
                        className='h-full w-full text-gray-300'viewBox='0 0 12 82'
                        fill='none'
